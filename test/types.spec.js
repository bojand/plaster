...
describe('Plaster internals', function () {
  describe('any type', function () {
    ...
    describe('custom get', function () {
      it('getter to transform property on get', function () {
        var schema = plaster.schema({
          ...
          lastName: String,
          name: {
            type: String, get: function (value) {
              if (value) {
                return value;
              } else {
    ...
    describe('default', function () {
      it('default as function should only be called once', function (done) {
        ...
        var schema = plaster.schema({
          token: {
            type: String, readOnly: true, default: function () {
              return i++;
            }
          },
          defaultDate: {
    ...
    describe('alias', function () {
      ...
      before(function () {
        ...
        var schema = plaster.schema({
          ...
          regionTransform: {
            type: 'alias', index: 'state', transform: function (value) {
              if (value === 'test') {
        ...
        SModel = plaster.model('SModel', schema);
      });
  ...
  describe('String', function () {
    ...
    describe('enum', function () {
      ...
      it('default must be in enum or is rejected', function () {
        ...
        var SModel2 = plaster.model('smodel2', schema);
      ...
      it('default should be set when in enum', function () {
        ...
        var SModel3 = plaster.model('smodel3', schema);
  ...
  describe('Object', function () {
    describe('accessing properties', function () {
      ...
      it('should accept Object as type and set properties without initializing object', function () {
        plaster = new plaster.Plaster();
        var schema = plaster.schema({
          anObject: Object
        });
        ...
        o.anObject.prop = 'foo';
        expect(o.anObject.prop).to.be.ok;
        expect(o.anObject.prop).to.equal('foo');
      });
    });
    ...
    describe('schema', function () {
      ...
      before(function () {
        plaster = new plaster.Plaster();
        var ProfileSchema = plaster.schema({
          firstName: String,
          age: Number,
          notEmptyString: {type: String, minLength: 1}
        });

        Profile = plaster.model('Profile', ProfileSchema);
        ...
        Persona = plaster.model('Persona', schema);
      });
      ...
      it('should allow nested schemas', function () {
        ...
        expect(o.profile.firstName).to.be.a('string');
        expect(o.profile.firstName).to.equal('123');

        o.profile.age = '23';
        expect(o.profile.age).to.be.a('number');
        expect(o.profile.age).to.equal(23);

        o.profile.notEmptyString = '';
        expect(o.profile.notEmptyString).to.equal(undefined);
      });
      ...
      it('should allow shorthand declaration of nested schema', function () {
        ...
        expect(o.shorthandProfile.firstName).to.be.a('string');
        expect(o.shorthandProfile.firstName).to.equal('123');

        o.shorthandProfile.age = '23';
        expect(o.shorthandProfile.age).to.be.a('number');
        expect(o.shorthandProfile.age).to.equal(23);

        o.shorthandProfile.notEmptyString = '';
        expect(o.shorthandProfile.notEmptyString).to.equal(undefined);
      });
      ...
      it('should allow shorthand declaration of nested schema to use "name" index', function () {
        ...
        expect(o.shorthandProfile.name).to.be.a('string');
        expect(o.shorthandProfile.name).to.equal('123');
      });
      ...
      it('should allow default values', function () {
        ...
        var ModelWithDefaults = plaster.model('ModelWithDefaults', schema);

        var m = new ModelWithDefaults();

        expect(m.profile.firstName).to.equal('Jane');
      });
    });
  });
  ...
  describe('Array', function () {
    describe('construction', function () {
      it('should allow you to pass an array to Model constructor for Array-type fields', function () {
        ...
        var AModel1 = plaster.model('amodel1', schema);
      ...
      it('should allow you to pass an array to constructor for Array-type fields within other objects', function () {
        ...
        var AModel2 = plaster.model('amodel2', schema);
    ...
    describe('typecasting', function () {
      ...
      before(function () {
        ...
        SModel = plaster.model('smodela', schema);
      });
    ...
    describe('unique', function () {
      ...
      before(function () {
        ...
        UAModel = plaster.model('uamodel', schema);
      });
    ...
    describe('Array prototype', function () {
      it('concat', function () {
        ...
        var APModel = plaster.model('apmodel', schema);
    ...
    describe('toArray', function () {
      ...
      before(function () {
        ...
        ATModel = plaster.model('atmodel', schema);
      });
  ...
  describe('Date', function () {
    describe('typecasting', function () {
      ...
      before(function () {
        ...
        SModel = plaster.model('dtmodel', schema);
      });
    ...
    describe('dateTransform', function () {
      before(function () {
        ...
        SModel = plaster.model('dtmodel2', schema);
      });
  ...
  describe('type definition', function () {
    ...
    it('should allow custom type definition properties', function () {
      ...
      var TModel1 = plaster.model('tmodel1', schema);
    ...
    it('should allow custom type definition using properties hash with "type" property', function () {
      ...
      var TModel2 = plaster.model('tmodel2', schema);
    ...
    it('should allow multiple custom type definitions with the same custom type properties object', function () {
      ...
      var TModel3 = plaster.model('tmodel3', schema);
