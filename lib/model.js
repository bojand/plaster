...
export class Model {
   ...
   * @param {Boolean} options.virtuals - apply virtual getters (defaults to <code>false</code>)
   * @param {Boolean} options.minimize - remove empty objects (defaults to <code>true</code>)
   * @param {Boolean} options.dateToISO - convert dates to string in ISO format using <code>Date.toISOString()</code> (defaults to <code>false</code>)
   *
